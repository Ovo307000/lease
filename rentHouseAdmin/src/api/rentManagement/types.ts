import {AgreementSource, AgreementStatus, AppointmentStatus, RoomReleaseStatus,} from '@/enums/constEnums'
import {ApartmentInterface, TermInfoInterface,}                                  from '@/api/apartmentManagement/types'
