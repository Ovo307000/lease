...
export const ApartmentReleaseStatusMap = [
    {
        label: '未发布',
        value: ApartmentReleaseStatus.NOT_RELEASED
    },
    {
        label: '已发布',
        value: ApartmentReleaseStatus.RELEASED
    },
]
...
export const RoomReleaseStatusMap = [
    {
        label: '未发布',
        value: RoomReleaseStatus.NOT_RELEASED
    },
    {
        label: '已发布',
        value: RoomReleaseStatus.RELEASED
    },
]
// 房间的入住状态
...
export const RoomCheckInStatusMap = [
    {
        label: '未入住',
        value: RoomCheckInStatus.NOT_CHECK_IN
    },
    {
        label: '已入住',
        value: RoomCheckInStatus.CHECK_IN
    },
]
...
export const AppointmentStatusMap = [
    ...
    {
        label: '已看房',
        value: AppointmentStatus.VIEWED
    },
    {
        label: '已过期',
...
export const AgreementStatusMap = [
    ...
    {
        label: '已签约',
        value: AgreementStatus.SIGNED
    },
    {
        label: '已取消',
        value: AgreementStatus.CANCELLED
    },
    {
        label: '已到期',
        value: AgreementStatus.EXPIRED
    },
    {
        label: '退租待确认',
        value: AgreementStatus.TO_BE_CONFIRMED
    },
    {
        label: '已退租',
        value: AgreementStatus.CONFIRMED
    },
    {
        label: '续约待确认',
        value: AgreementStatus.RENEW_TO_BE_CONFIRMED
    },
]
...
export const AgreementSourceMap = [
    {
        label: '新签',
        value: AgreementSource.NEW
    },
    {
        label: '续约',
        value: AgreementSource.RENEW
    },
]
...
export const SystemUserTypeMap = [
    {
        label: '管理员',
        value: SystemUserType.ADMIN
    },
    {
        label: '普通用户',
        value: SystemUserType.NORMAL
    },
]
...
export const SystemUserStatusMap = [
    {
        label: '禁用',
        value: SystemUserStatus.DISABLED
    },
    {
        label: '正常',
        value: SystemUserStatus.NORMAL
    },
]
