  ...
  <el-card>
    ...
    >
      <template #tableHeader>
        <el-button icon = "Plus" type = "primary" @click = "addHandle">
          新增租约
        </el-button>
      </template>
      <!-- 表格操作 -->
      <template #operation = "scope">
        <el-button icon = "Edit" type = "success" @click = "editHandle(scope.row)">
          修改
        </el-button>
        <el-button icon = "Delete" type = "danger" @click = "deleteHandle(scope.row)">
          删除
        </el-button>
        <el-button
...
import {AgreementSourceMap, AgreementStatus, AgreementStatusMap, getLabelByValue,}    from '@/enums/constEnums'
import {deleteAgreementInfoById, getAgreementInfoList, updateAgreementStatusById,}    from '@/api/rentManagement'
